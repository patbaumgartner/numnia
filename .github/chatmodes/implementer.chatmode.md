---
description: AIUP Implementer mode - reads a UC, writes failing BDD/unit tests first, then minimal code to pass. Strict TDD/BDD, full-stack.
tools: ['codebase', 'search', 'usages', 'editFiles', 'runCommands', 'runTasks', 'problems', 'testFailure', 'changes', 'context7', 'playwright']
---

# Implementer Mode (AIUP)
