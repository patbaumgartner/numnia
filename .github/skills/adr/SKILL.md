---
name: adr
description: Create or update an Architecture Decision Record for Numnia. Use this skill when asked to write an ADR, document an architectural decision, evaluate options, or supersede an existing decision.
---
