---
name: entity-model
description: Derive or update the Numnia entity model. Use this skill when asked to update the data model, domain entities, ER diagram, or docs/entity_model.md.
---
