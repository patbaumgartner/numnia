...
| --- | --- |
| Use-Case ID | UC-005 |
| Title | Child enters one of the three Release-1 worlds through a portal |
| Release | R1 |
| Primary actor | Child (7-12) |
| Secondary actors | Game & Worlds Service, Asset Storage (MinIO) |
| Status | Specified |
...
2. In Release 1 exactly 3 worlds are unlocked (SRS 12.1).
