# ADR-003 - OpenAPI 3.1 as the API Contract; GraphQL Only Where Aggregation Justifies It
...
- Real-time / multiplayer flows use **WebSocket** (see ADR-004).
