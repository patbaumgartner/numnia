# ADR-005 - Bounded Contexts Aligned with SRS Chapters 6.x
...
- **Option A** - One bounded context per SRS chapter 6.x area, each as a Spring Boot module inside the modulith (see ADR-009).
...
- Option C - operationally too heavy for a 1-2 person team (see ADR-009).
