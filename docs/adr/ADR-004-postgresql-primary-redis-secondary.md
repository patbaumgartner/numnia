# ADR-004 - PostgreSQL as Primary Persistence, Redis Only for Session and Matchmaking
...
| References | SRS §4.1, NFR-PRIV-001, NFR-OPS-003, arc42 §2, §5, ADR-002 (current version pins) |
